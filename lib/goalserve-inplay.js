...
class GoalserveInplayService {
  ...
  normalizeEvent(event, sport) {
    ...
    // CRITICAL: Goalserve inplay feed has home/away REVERSED
    // Their "home" = actual away team, their "away" = actual home team
    ...
    // CRITICAL: Goalserve inplay has home/away REVERSED, so we swap scores too
  ...
  normalizeOdds(odds, sport = 'unknown') {
    ...
    for (const market of markets) {
      ...
      // CRITICAL: Goalserve inplay has home/away REVERSED, swap the assignments
      ...
      // CRITICAL: Goalserve inplay has home/away REVERSED
