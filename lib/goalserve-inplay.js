...
class GoalserveInplayService {
  ...
  normalizeOdds(odds) {
    ...
    for (const market of markets) {
      ...
      if ((marketName.includes('money line') || marketName.includes('home/away') || marketName === 'home away') && !normalized.moneyline) {
      ...
      if ((marketName.includes('handicap') || marketName.includes('spread')) && !normalized.spread) {
      ...
      // Over/Under / Totals
      if ((marketName.includes('over/under') || marketName.includes('total')) && !normalized.total) {
