...
// for users until an admin edits the slots. The first four slots match
// the legacy default order; the remaining four surface the newer branded
// promo tiles (Pick Battles, Premium Discord, Free Pick, Top Cappers).
