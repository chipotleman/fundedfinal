...
function parseGoalserveGame(match, sportKey) {
  ...
  // Goalserve uses correct convention: hometeam = home, awayteam = away
      ...
      if (isMoneylineType) {
        ...
        odds.forEach((odd, idx) => {
          ...
          const isHome = odd.name === '1' || odd.name === 'Home' || oddName === 'home' ||
            (homeNameLower && homeNameLower.length > 2 && (oddName.includes(homeNameLower) || homeNameLower.includes(oddName)));
          const isAway = odd.name === '2' || odd.name === 'Away' || oddName === 'away' ||
            (awayNameLower && awayNameLower.length > 2 && (oddName.includes(awayNameLower) || awayNameLower.includes(oddName)));
