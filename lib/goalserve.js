...
async function fetchFromGoalserve(endpoint, params = {}, timeoutMs = 15000) {
  ...
  // Add timeout to prevent hanging on slow Goalserve responses
  ...
  try {
    ...
    if (error.name === 'AbortError') {
      throw new Error(`Goalserve API timeout after ${timeoutMs}ms`);
    }
    throw error;
  }
}
