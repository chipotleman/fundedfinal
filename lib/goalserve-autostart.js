...
export function initializeGoalservePolling() {
  ...
  // Include all sports to ensure Ebasketball (esports), soccer, etc. are available
  const targetSports = ['basketball', 'hockey', 'amfootball', 'baseball', 'esports', 'soccer', 'tennis', 'volleyball'];
