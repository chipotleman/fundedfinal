...
const GOALSERVE_AUTH_URL = 'https://live.goalserve.com/api/v1/auth/gettoken';
...
async function getJwtToken() {
  ...
  try {
    ...
    // Goalserve requires form-encoded data with lowercase 'apikey'
    ...
    console.error('[Goalserve WS] Token request error:', error);
