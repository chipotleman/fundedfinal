...
export const profiles = pgTable("profiles", {
  ...
  favoriteTeams: jsonb("favorite_teams").$type<{ league: string; teamId: string }[]>().default([]),
  equippedFrame: varchar("equipped_frame", { length: 50 }),
  unlockedFrames: jsonb("unlocked_frames").$type<string[]>().default([]),
...
export const battleInvites = pgTable("battle_invites", {
  ...
  gameMode: varchar("game_mode", { length: 20 }).default('original'),
  status: varchar("status", { length: 20 }).default('pending').notNull(),
