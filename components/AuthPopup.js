        ...
        <div className="p-6 pt-8">
          ...
          <div className="mb-4">
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 font-medium py-3 px-4 rounded-xl"
              style={{ WebkitTapHighlightColor: 'transparent', backgroundColor: '#000000', color: '#ffffff', border: '1px solid #444444' }}
            >
