        ...
        <div className="p-6 pt-8">
          ...
          <div className="space-y-3 mb-4">
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-gray-100 text-gray-800 font-medium py-3 px-4 rounded-xl transition-all duration-200"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-[#1877F2] hover:bg-[#166FE5] text-white font-medium py-3 px-4 rounded-xl transition-all duration-200"
              style={{ WebkitTapHighlightColor: 'transparent' }}
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
