              ...
              {isLoggedIn && (
                <div className="hidden sm:flex items-center space-x-4">
                  <div className={`rounded-lg px-3 py-2 border transition-colors ${
                    hasActiveChallenge 
                      ? 'bg-[#111111] hover:bg-[#1a1a1a] border-gray-800/50 hover:border-gray-700' 
                      : 'bg-gradient-to-r from-green-500/10 to-blue-500/10 border-green-500/30 hover:border-green-500/50'
                  }`}>
                    <button
                      onClick={() => hasActiveChallenge ? setShowBalanceModal(true) : window.dispatchEvent(new CustomEvent('openChallengePopup'))}
                      className="flex items-center space-x-2"
                    >
                      <svg className={`w-4 h-4 ${hasActiveChallenge ? 'text-green-400' : 'text-green-400 animate-pulse'}`} fill="currentColor" viewBox="0 0 20 20">
                      ...
                      {hasActiveChallenge && userProfile ? (
                        ...
                        <span className="text-green-400 font-bold text-sm">Get Funded</span>
                      )}
                    </button>
                  </div>
                </div>
