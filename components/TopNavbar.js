  ...
  return (
    <>
      <nav className="sticky top-0 left-0 right-0 z-50" style={{ backgroundColor: isDarkMode ? '#000000' : '#ffffff' }}>
        <div className="px-3 sm:px-6 h-[90px] sm:h-auto sm:py-1 sm:-mb-6 flex items-center">
          <div className="flex items-center justify-between w-full sm:justify-between min-h-[90px] sm:min-h-[48px] relative">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 sm:relative sm:top-auto sm:translate-y-0 sm:-mt-[5.75px]">
              <Link href="/" className="flex items-center">
                <img
                  ...
                  alt="Piks"
                  className="h-[200px] sm:h-[230px] w-auto brightness-100 hover:brightness-125 transition-all duration-300 hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]"
                  style={{
            ...
            <div className="flex items-center space-x-2 sm:space-x-4 absolute right-3 sm:relative sm:right-0">
              ...
              {(betSlipCount > 0 || (demoBetSlipCount > 0 && !isLoggedIn)) && (
                <button
                  ...
                  className="relative bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-2 sm:py-3 px-2 sm:px-6 rounded-lg transition-all duration-300 flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base"
                >
              ...
              <button
                onClick={toggleTheme}
                className="w-9 h-9 sm:w-10 sm:h-10 flex items-center justify-center rounded-full hover:bg-[#1a1a1a] transition-all duration-300"
