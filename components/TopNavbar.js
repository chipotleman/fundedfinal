            ...
            <div className="hidden lg:flex items-center space-x-8">
              {isLoggedIn ? (
                <>
                  ...
                  <Link href="/social" className="font-light text-sm uppercase tracking-wider transition-all duration-300 hover:scale-105 hover:drop-shadow-[0_0_8px_rgba(59,130,246,0.6)]" style={{ color: isDarkMode ? '#d1d5db' : '#374151' }}>
                    Social
                  </Link>
                </>
              ) : (
