            ...
            <div className="flex items-center space-x-2 sm:space-x-4 absolute right-3 sm:relative sm:right-0">
              ...
              {(betSlipCount > 0 || (demoBetSlipCount > 0 && !isLoggedIn)) && (
                <button
                  ...
                  className="relative text-white font-bold py-2 sm:py-3 px-2 sm:px-6 rounded-lg flex items-center space-x-1 sm:space-x-2 text-sm sm:text-base"
                  style={{ backgroundColor: '#2563eb', marginRight: '35px' }}
                >
