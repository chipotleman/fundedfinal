...
export default function SessionSummaryPopup({ isOpen, onClose, sessionData }) {
  ...
  const sessionPnL = (startingBalance !== null && endingBalance !== null) 
    ? endingBalance - startingBalance 
    : 0;
  const isProfitable = sessionPnL >= 0;
          ...
          <div className="bg-slate-800/30 rounded-2xl p-4 mb-4 border border-slate-700/50">
            ...
            {challengeName && (
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-white font-medium">{challengeName}</span>
                  {challengePhase && (
            ...
            {startingBalance !== null && endingBalance !== null && (
              <div className="border-t border-slate-700/50 pt-3 mt-3 space-y-2">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm">Ending Balance</span>
                  <span className="text-white font-medium">${endingBalance.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                </div>
              </div>
            )}
          </div>
