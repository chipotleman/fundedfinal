  ...
  return (
    <>
      <style>{`
        ...
        @media (hover: hover) {
          .find-opponent-card:hover { transform: scale(1.01); }
        }
        .find-opponent-card:active { transform: scale(0.98); }
      `}</style>

      <div
        className="find-opponent-card w-[calc(100vw-32px)] md:w-[864px] flex-shrink-0 rounded-2xl overflow-hidden cursor-pointer transition-transform duration-200 relative h-[140px] md:h-[180px]"
        style={{
          background:
