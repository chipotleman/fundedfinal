    ...
    <>
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 bottom-0 w-80 sm:w-96 bg-black border-l border-gray-800/50 z-[99] flex flex-col shadow-2xl">
            ...
            <div className="flex-1 overflow-y-auto">
              {bets.length === 0 ? (
                ...
                <div className="p-3 space-y-3">
                  {bets.map((bet) => (
                    <div key={bet.id} className="bg-[#111111] rounded-xl p-3 border border-gray-800/50">
                      <div className="flex items-start justify-between gap-2 mb-2">
                        ...
                        <button onClick={() => removeBet(bet.id)} className="text-gray-500 hover:text-red-400">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="relative flex-1">
                            ...
                            <input
                              ...
                              className="w-full pl-6 pr-2 py-2 bg-[#1a1a1a] border border-gray-700 rounded-lg text-white text-sm focus:outline-none focus:border-green-500"
                  ...
                  {bets.length > 1 && (
                    <div className="bg-[#111111] rounded-xl p-3 border border-gray-800/50">
            ...
            {bets.length > 0 && (
              <div className="p-3 border-t border-gray-800/50 bg-[#0a0a0a]">
                ...
                {totalStake > bankroll && (
                  <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-2 mb-2">
                    <p className="text-red-400 text-xs">Insufficient balance: ${bankroll.toFixed(2)}</p>
                  </div>
                )}

                {validation.belowMinimum && (
                  <div className="bg-red-500/20 border border-red-500/30 rounded-lg p-2 mb-2">
                    <p className="text-red-400 text-xs">Min bet: ${minBetAmount}</p>
                  </div>
                )}
