...
export default function BetSlip({ bankroll, onClose }) {
  ...
  return (
    <>
      ...
      {/* Bet Slip Panel */}
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-sm lg:max-w-md lg:w-96 bg-slate-800 border-l border-slate-700 flex flex-col z-50 transform translate-x-0 transition-transform duration-300 ease-in-out"></div>
        {/* Header */}
