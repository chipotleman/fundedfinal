...
export default function TrendingBetContainer() {
  ...
  return (
    <div
      className="w-[234px] md:w-[302px] flex-shrink-0 rounded-2xl overflow-hidden cursor-pointer transition-transform duration-200 relative h-[140px] md:h-[180px] hover:scale-[1.02] active:scale-[0.98]"
      style={{ backgroundColor: '#000' }}
      onClick={handleClick}
      role="button"
      aria-label="Trending now — see what the public is betting on"
    >
      {/* Container width matches the trimmed banner aspect (1360×812 ≈ 1.68)
