...
export default function PackagesPopup({ isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal Content */}
      <div className="relative bg-slate-900 rounded-2xl border-2 border-slate-700 max-w-md w-full mx-4 max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="text-center p-6 pb-0">
          ...
          <p className="text-gray-300 text-sm mb-4">Swipe left/right to explore packages</p>
        ...
        >
          <div className={`relative bg-slate-800 rounded-2xl border-2 p-6 transition-all duration-300 ${
            ...
            <div className="text-center mb-6">
              <h3 className="text-xl font-bold text-white mb-2">{currentPackage.name}</h3>
              <div className="text-3xl font-black text-green-400 mb-1">{currentPackage.fundingAmount}</div>
              <div className="text-gray-400 text-sm">Funding Amount</div>
            </div>

            <div className="text-center mb-6">
              <div className="text-2xl font-bold text-white">{currentPackage.price}</div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex justify-between items-center">
                ...
                <span className="text-green-400 font-bold">{currentPackage.target}</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-gray-300 text-sm">Daily Loss Limit:</span>
                <span className="text-red-400 font-bold">{currentPackage.dailyLoss}</span>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between mt-6">
            <button
              onClick={prevPackage}
              className="w-10 h-10 bg-slate-800 hover:bg-slate-700 rounded-full flex items-center justify-center text-gray-400 hover:text-white transition-colors"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
