    ...
    localStorage.setItem(
      ...
      JSON.stringify({
        ...
        startingBalance: parseInt(
          packageData.fundingAmount.replace(/[$,]/g, ""),
        ),
        profitTarget: parseInt(packageData.target.replace(/[$,]/g, "")),
        dailyLossLimit:
          parseFloat(packageData.dailyLoss.replace("%", "")) / 100,
      }),
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-4">
        <div className="text-center">
          ...
          <p className="text-base sm:text-lg text-gray-300 max-w-2xl mx-auto mb-6">
            Choose the funding level that matches your betting strategy and
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="lg:hidden pt-8">
          <div className="overflow-x-auto scrollbar-hide">
            <div
              className="flex space-x-6 pb-4 pt-4"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
            <div>
              ...
              <p className="text-gray-400 text-xs">
                Choose your funding package and complete payment
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-xs">
                Reach your profit target within 14 days while following the
                rules
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-400 text-xs">
                Receive your funding and start earning 80%+ of all profits
              </p>
            </div>
          </div>
        </div>
