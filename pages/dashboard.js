...
export default function Dashboard() {
  ...
  return (
    <div className="bg-black text-white min-h-screen font-mono pt-[120px] flex">
      {/* Sidebar */}
      ...
      <div className="flex-1 flex flex-col">
        <TopNavbar bankroll={bankroll} selectedBets={selectedBets} setShowBalanceModal={setShowBalanceModal} setShowBetSlipModal={setShowBetSlipModal} />
