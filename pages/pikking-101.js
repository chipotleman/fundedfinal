          ...
          <div className="space-y-6" style={{ color: isDarkMode ? '#d1d5db' : '#374151' }}>
            ...
            <section>
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold mb-2" style={{ color: isDarkMode ? '#ffffff' : '#000000' }}>Moneyline</h3>
                  <p>Pick the team to win the game outright. The simplest bet type.</p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2" style={{ color: isDarkMode ? '#ffffff' : '#000000' }}>Spread</h3>
                ...
                <div>
                  <h3 className="font-semibold mb-2" style={{ color: isDarkMode ? '#ffffff' : '#000000' }}>Totals (Over/Under)</h3>
                  <p>Pick whether the combined score of both teams will be over or under a set number.</p>
                </div>

                <div>
                  <h3 className="font-semibold mb-2" style={{ color: isDarkMode ? '#ffffff' : '#000000' }}>Parlays</h3>
