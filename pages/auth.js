...
export default function AuthPage() {
  ...
  const getBackgroundGradient = () => {
    if (!selectedChallenge) return 'bg-black';
    
    switch(selectedChallenge.id) {
      case 1: // Starter Challenge - Blue theme
        return 'bg-gradient-to-br from-blue-950 via-black to-black';
      case 2: // Pro Challenge - Green theme
        return 'bg-gradient-to-br from-green-950 via-black to-black';
      case 3: // Elite Challenge - Purple theme
        return 'bg-gradient-to-br from-purple-950 via-black to-black';
      default:
        return 'bg-black';
    }
  };
