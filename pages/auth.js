          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-slate-700/50 shadow-2xl">
            <div className="text-center mb-8">
              <div className="mb-6">
                ...
                {/* Divider - Only show if at least one OAuth provider is enabled */}
                {(process.env.NEXT_PUBLIC_GOOGLE_ENABLED || process.env.NEXT_PUBLIC_APPLE_ENABLED || process.env.NEXT_PUBLIC_FACEBOOK_ENABLED) && (
